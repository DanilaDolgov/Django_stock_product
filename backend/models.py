...
class OrderItem(models.Model):
    ...
    product_info = models.ForeignKey(ProductInfo, verbose_name='Информация о продукте', related_name='ordered_items',
                                     blank=True,
                                     on_delete=models.CASCADE)
    shop_info = models.ForeignKey(Shop, verbose_name='Информация о магазине', related_name='ordered_items',
                                  blank=True,
                                  on_delete=models.CASCADE)
    quantity = models.PositiveIntegerField(verbose_name='Количество')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['order_id', 'product_info', 'shop_info'], name='unique_order_item'),
        ]
